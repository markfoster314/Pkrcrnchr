...
#include <array>
#include <functional>
#include "../peval/Card.h"
#include "../peval/CardSet.h"
#include "../peval/Rank.h"  // needed for NUM_RANK
#include "../peval/Suit.h"  // needed for NUM_SUIT
#include "../util/lastbit.h"
#include <string>
 ...
 */
struct isLive : public std::binary_function<pkrcrnchr::CardSet,
                                            pkrcrnchr::CardSet,
                                            bool>
{
...
public:
    ...
    pkrcrnchr::CardSet deal(size_t ncards)
    {
        // TODO: fix and test this code, edge cases clearly at risk here
        if (ncards == 0)
            return pkrcrnchr::CardSet();
    ...
    pkrcrnchr::CardSet dead() const
    {
        pkrcrnchr::CardSet cs;
     ...
     */
    void remove(const pkrcrnchr::CardSet& cards)
    {
