...
vector<int> pkrcrnchr::findSuitPermutation(const CardSet& source, const CardSet& dest)
{
    vector<int> rot(4, -1);
...
CardSet pkrcrnchr::canonizeToBoard(const CardSet& board, const CardSet& hand)
{
